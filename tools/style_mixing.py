...
def generate_style_mix(
    ...
    all_images = G.synthesis(all_w, noise_mode=noise_mode, force_fp32=False if torch.cuda.is_available() else True)
    ...
    for row_seed in row_seeds:
        for col_seed in col_seeds:
            ...
            image = G.synthesis(w[np.newaxis], noise_mode=noise_mode, force_fp32=False if torch.cuda.is_available() else True)
